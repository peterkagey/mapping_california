...
def generate_intersections(reader, verbose=False):
    ...
    return _sort_intersections(intersections)

def _sort_intersections(intersections):
    """
    Given a set of intersections generated by generate_intersections,
    sort them in order from most neighbors to least.
    ...
    OrderedDict
        A dictionary ordered from most neighbors to least neighbors.
    """ 
